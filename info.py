...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1807927334 7436687322 6765929934').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ABHISHEK:ABHISHEK@cluster0.0r8bnmx.mongodb.net/?appName=Cluster0")
...
SECOND_SHORTLINK_URL = environ.get('SECOND_SHORTLINK_URL', 'arlinks.in')
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'c8deaa7cb811330e142c77d4050754c9cda60dfa')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Movie_house_club')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001934268680')).split()]
